...
import { MovingGradient } from "@/components/animata/moving-gradient";
...
function BentoCard(props: BentoCardProps) {
	const { children, title, icon, description, gradient, className } = props;
	return (
		<MovingGradient
			animated={false}
...
export function Gradient() {
	return (
		<div className="dark:bg-zinc-950 p-4 border border-dashed rounded">
