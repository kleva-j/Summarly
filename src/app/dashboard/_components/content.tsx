...
const Notifications = dynamic(
  async () => (await import("./notification")).Notifications,
  { ssr: false }
);
const RecordingsTab = dynamic(
  async () => (await import("./recording")).RecordingTab,
  { ssr: false }
);
const Overview = dynamic(async () => (await import("./overview")).Overview, {
  ssr: false,
});
